...
impl DrmNode {
    ...
    pub fn from_fd<A: AsRawFd>(fd: A) -> Result<DrmNode, CreateDrmNodeError> {
        ...
        {
            // TODO: FreeBSD specific checks to get the major and minor?
        }

        if !is_node_drm(major, minor) {
...
#[cfg(target_os = "linux")]
fn is_node_drm(major: u64, minor: u64) -> bool {
...
pub fn is_drm_node_drm(major: u64, _minor: u64) -> bool {
    ...
    // let name = devname_r(makedev(major, minor));
    // // ... Implementation to go from ras to a string.
...
#[cfg(not(any(target_os = "linux", target_os = "freebsd")))]
pub fn is_node_drm(major: u64, _minor: u64) -> bool {
    major == DRM_MAJOR
}
